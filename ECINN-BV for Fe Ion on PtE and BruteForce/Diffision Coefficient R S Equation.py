...
alpha = 0.79 # Using the transfer coefficient obtained from "Tafel Analysis Tafel Region Method.py"
...
d_calc = ((lr.coef_[0])/np.sqrt(alpha)/0.496)**2 #irreversible 
print('The diffusion coefficient predicted using irreversible R-S equation is',d_calc)
d_calc = ((lr.coef_[0])/0.446)**2 #irreversible 
print('The diffusion coefficient predicted using reversible R-S equation is',d_calc)
