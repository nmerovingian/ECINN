...
from .layer import GradientLayer,BVLayer,DiffusionCoefficientLayer

class ECINN:
    """
    Build an ECINN-BV network for the quasi-reversible voltammograms. 
    ...
    def build(self,outerBoundary):
        ...
        u_ini_1 = tf.keras.layers.Dense(1,activation=None,use_bias=False,kernel_initializer='ones',trainable=False,name='Ini_1')(u_ini_1)
        u_ini_2 = tf.keras.layers.Dense(1,activation=None,use_bias=False,kernel_initializer='ones',trainable=False,name='Ini_2')(u_ini_2)
        u_ini_3 = tf.keras.layers.Dense(1,activation=None,use_bias=False,kernel_initializer='ones',trainable=False,name='Ini_3')(u_ini_3)
        ...
        u_eqn_1 = tf.keras.layers.Dense(1,activation=None,use_bias=False,kernel_initializer='ones',trainable=False,name='Domain_1')(u_eqn_1)
        u_eqn_2 = tf.keras.layers.Dense(1,activation=None,use_bias=False,kernel_initializer='ones',trainable=False,name='Domain_2')(u_eqn_2)
        u_eqn_3 = tf.keras.layers.Dense(1,activation=None,use_bias=False,kernel_initializer='ones',trainable=False,name='Domain_3')(u_eqn_3)
        ...
        u_bnd1_1 = tf.keras.layers.Dense(1,activation=None,use_bias=False,kernel_initializer='ones',trainable=False,name='u_bnd1_1')(u_bnd1_1)
        u_bnd1_2 = tf.keras.layers.Dense(1,activation=None,use_bias=False,kernel_initializer='ones',trainable=False,name='u_bnd1_2')(u_bnd1_2)
        u_bnd1_3 = tf.keras.layers.Dense(1,activation=None,use_bias=False,kernel_initializer='ones',trainable=False,name='u_bnd1_3')(u_bnd1_3)
